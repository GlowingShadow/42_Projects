Dump of assembler code for function main:
   ...
   0x08048513 <+31>:    call   0x8048410 <fopen@plt>	; call fopen
   0x08048518 <+36>:    mov    %eax,0x9c(%esp)			; 156
   ...
   0x08048533 <+63>:    cmpl   $0x0,0x9c(%esp)			; 156 ; retour fopen == 0 ?
   0x0804853b <+71>:    je     0x8048543 <main+79>		; ------> 1 -> 5
   0x0804853d <+73>:    cmpl   $0x2,0x8(%ebp)
   0x08048541 <+77>:    je     0x804854d <main+89>		; ------> 2
>1 0x08048543 <+79>:    mov    $0xffffffff,%eax
   0x08048548 <+84>:    jmp    0x8048615 <main+289>		; ------> 5

>2 0x0804854d <+89>:    lea    0x18(%esp),%eax			; 24
   0x08048551 <+93>:    mov    0x9c(%esp),%edx			; 156
   0x08048558 <+100>:   mov    %edx,0xc(%esp)			; 12
   0x0804855c <+104>:   movl   $0x42,0x8(%esp)			; 66
   0x08048564 <+112>:   movl   $0x1,0x4(%esp)
   0x0804856c <+120>:   mov    %eax,(%esp)
   0x0804856f <+123>:   call   0x80483d0 <fread@plt>	; call fread
   0x08048574 <+128>:   movb   $0x0,0x59(%esp)			; 89
   0x08048579 <+133>:   mov    0xc(%ebp),%eax			; 12
   0x0804857c <+136>:   add    $0x4,%eax
   0x0804857f <+139>:   mov    (%eax),%eax
   0x08048581 <+141>:   mov    %eax,(%esp)
   0x08048584 <+144>:   call   0x8048430 <atoi@plt>
   0x08048589 <+149>:   movb   $0x0,0x18(%esp,%eax,1)	; 24 , mult ?
   0x0804858e <+154>:   lea    0x18(%esp),%eax			; 24
   0x08048592 <+158>:   lea    0x42(%eax),%edx			; 66
   0x08048595 <+161>:   mov    0x9c(%esp),%eax			; 156
   ...
   0x080485b3 <+191>:   call   0x80483d0 <fread@plt>	; call fread
   0x080485b8 <+196>:   mov    0x9c(%esp),%eax			; 156
   0x080485bf <+203>:   mov    %eax,(%esp)
   0x080485c2 <+206>:   call   0x80483c0 <fclose@plt>	; call fclose
   0x080485c7 <+211>:   mov    0xc(%ebp),%eax			; 12
   ...
   0x080485da <+230>:   call   0x80483b0 <strcmp@plt>	; call strcmp
   0x080485df <+235>:   test   %eax,%eax
   0x080485e1 <+237>:   jne    0x8048601 <main+269>		; ------> 3
   0x080485e3 <+239>:   movl   $0x0,0x8(%esp)
   0x080485eb <+247>:   movl   $0x8048707,0x4(%esp)		; "sh"
   0x080485f3 <+255>:   movl   $0x804870a,(%esp)		; "/bin/sh"
   0x080485fa <+262>:   call   0x8048420 <execl@plt>	; call execl

   0x080485ff <+267>:   jmp    0x8048610 <main+284>		; ------> 4
>3 0x08048601 <+269>:   lea    0x18(%esp),%eax			; 24
   0x08048605 <+273>:   add    $0x42,%eax				; 66
   0x08048608 <+276>:   mov    %eax,(%esp)
   0x0804860b <+279>:   call   0x80483e0 <puts@plt>		; call puts
>4 0x08048610 <+284>:   mov    $0x0,%eax
>5 0x08048615 <+289>:   lea    -0x8(%ebp),%esp
