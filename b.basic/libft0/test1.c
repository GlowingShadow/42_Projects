...
/*   Updated: 2014/11/08 14:52:22 by REDACTED         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		test_strlen(void)
{
	char *str="Coucou";
	char *str2="";
	if (ft_strlen(str) != ft_strlen(str))
		return (0);
	if (ft_strlen(str2) != ft_strlen(str2))
		return (0);
	return (1);
}
...
int		test_strlcat(void)
{
	...
	while (i < 30)
	{
		k = (int)ft_strlcat(target,s1,i);
		j = (int)strlcat(target_,s1_,i);
		if (k != j)
			return (0);
		i++;
	}
